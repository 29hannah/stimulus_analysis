...
print("Averaged rolloff from distance 1 to distance 5:")
# Distance 1
...
for sound_file_path in sound_file_paths_dis1:
    ...
    cen = sound.spectral_feature(feature='rolloff')
...
# Creating boxplot
fig = plt.figure()
fig.suptitle('Rolloff over distance categories', fontsize=10)

ax = fig.add_subplot(111)
ax.boxplot(overall_list)

ax.set_xlabel('Distance category')
ax.set_ylabel('Rolloff')
'''
plt.show()
'''
plt.savefig("pilot2_rolloff_overall")
